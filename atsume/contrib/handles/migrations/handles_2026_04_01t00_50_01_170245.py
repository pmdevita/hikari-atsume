...
async def forwards():
    ...
    manager.add_table(
        class_name="ComponentDM",
        tablename="component_dm",
        schema=None,
        columns=None,
    )

    manager.add_table(
        class_name="ComponentChannelHandle",
        tablename="component_channel_handle",
        schema=None,
        columns=None,
    )

    manager.add_column(
        table_class_name="ComponentDM",
        tablename="component_dm",
        column_name="id",
        db_column_name="id",
    ...
    manager.add_column(
        table_class_name="ComponentChannelHandle",
        tablename="component_channel_handle",
        column_name="id",
        db_column_name="id",
        column_class_name="Serial",
