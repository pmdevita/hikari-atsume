...
class AtsumeEventListener:
    def __init__(self, callback: typing.Callable):
        ...
        self.permissions: typing.Optional[typing.Type[AbstractComponentPermissions]] = None

    def __call__(self, event: hikari.Event):
        if self.permissions:
...
def with_listener(callback: typing.Callable):
