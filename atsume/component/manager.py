...
def get_component_config(module_path):
    ...
    app_configs = [
        ...
        if (
                issubclass(candidate, ComponentConfig)
                and candidate is not ComponentConfig
        )
    ]
...
class ComponentManager:
    ...
    def get_config_from_models_path(self, models_path: str) -> ComponentConfig:
